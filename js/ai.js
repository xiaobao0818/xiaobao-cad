...
const SYSTEM_PROMPT = [
  ...
  '- 图纸幅面（GB/T 14689）：默认 A3 竖向 420×297mm；图框距纸边 10mm；标题栏在右下角（约 180×56，含图名/比例/图号/材料）；明细栏在标题栏上方。',
  '- 图纸要素齐备：主视图 + 尺寸标注（线性为主，直径 ⌀ / 半径 R，覆盖全部关键尺寸）+ 图框 + 标题栏 + 明细栏；主视图的关键圆（轮廓/轮毂/轴孔）必须画出并标注直径。',
