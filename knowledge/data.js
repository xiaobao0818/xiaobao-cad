...
export const STANDARDS = [
  { code: 'GB/T 14689', name: '图纸幅面标准', note: 'A3 竖向 420×297mm 标准幅面；图框距纸边 10mm；标题栏右下角（常用 180×56，含图名/比例/图号/材料）；明细栏在标题栏上方' },
  { code: 'GB/T 10609.1', name: '标题栏标准', note: '标题栏位于图纸右下角，含图名、图号、比例、材料、单位；明细栏紧邻标题栏上方' },
  { code: 'GB/T 4458.4', name: '机械制图尺寸注法标准', note: '线性尺寸为主（机械图约 87%），直径标 ⌀、半径标 R、角度标度数；尺寸取整 mm；不重复标注、文字放轮廓外' },
